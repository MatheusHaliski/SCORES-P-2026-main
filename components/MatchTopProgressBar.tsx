import { MatchProgressState } from "@/types/liveMatch";
    ...
    <header className="rounded-2xl border border-white/15 bg-slate-900/70 p-4">
      ...
      <div className="mt-4">
        ...
        <div className="h-3 rounded-full bg-slate-700/70">
          <div
            className="h-3 rounded-full bg-gradient-to-r from-cyan-400 to-violet-500 transition-all duration-500 ease-linear"

...
export function PrimaryMenuButton({ href, title, description }: PrimaryMenuButtonProps) {
  return (
    <Link
      href={href}
      className="group w-full rounded-2xl border border-slate-300/30 bg-slate-900/70 px-6 py-5 text-left transition hover:-translate-y-1 hover:border-cyan-300/60 hover:bg-slate-800"
    >

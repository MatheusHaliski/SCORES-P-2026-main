...
export function MatchBoardLiveClient({
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl p-6">
      ...
      <div className="mt-3 rounded-xl border border-white/20 bg-slate-900/70 p-3 text-xs text-slate-100">
      ...
      {session.pendingInjury && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4">
          <div className="w-full max-w-xl rounded-xl border border-rose-300/50 bg-slate-900 p-4 text-sm text-slate-100">
            ...
            <div className="mt-3 grid gap-2">
              {session.userBench.map((bench) => (
                <button
                  ...
                  className="rounded bg-emerald-600 px-3 py-2 text-left text-xs font-bold text-white"
                >

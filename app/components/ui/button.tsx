...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/40 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.99]",
    {
        variants: {
            variant: {
                default:
                    "sa-premium-metallic-panel border border-white/30 bg-gradient-to-r from-[#2563eb] via-[#22c55e] to-[#38bdf8] text-white shadow-lg shadow-cyan-500/20 hover:brightness-110",
                outline:
                    "sa-premium-gradient-surface-soft border border-white/10 text-white/80 hover:text-white hover:bg-white/10",
